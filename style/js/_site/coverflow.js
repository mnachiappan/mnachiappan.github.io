...
window.onload = function () {
    ...
    function setupEvents() {
        ...
        view.addEventListener('mouseleft', tap);
        view.addEventListener('mouseright', drag);
...
function showModel(){
    var button = document.getElementById('try-button');
...
function changeImage(){
		...
		if(imageCounter<0){
			imageCounter = imageCounter + numbImages;
		}
		
		switch ((imageCounter % numbImages))
		{
            case 0:
                newUrl = "https://sketchfab.com/models/34e3a083ac8846008d742476c59cde0b/embed";
                break;
            case 1:
                newUrl = "https://sketchfab.com/models/b1f16fbca829476f988256d0e98a6d4b/embed";
                break;
		}
					
		document.getElementById("3Dmodel").src=newUrl;
		showModel();
	}
	
function addImage(){
	document.getElementById("3Dmodel").append();
}
